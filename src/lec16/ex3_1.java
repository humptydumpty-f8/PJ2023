...
public class ex3_1 extends JFrame {
    ...
    public ex3_1() {
        ...
        jPanel.add(new JLabel("КПІ",new ImageIcon("src/lec11/Herald_of_NTUU_KPI_logo.svg.png"),JLabel.LEFT));//мітка з іконкою і текстом
        jPanel.add(new JLabel("Кнопка з іконкою:",JLabel.RIGHT));
        jPanel.add(new JButton("КПІ",new ImageIcon("src/lec11/Herald_of_NTUU_KPI_logo.svg.png")));//кнопка з іконкою і текстом
